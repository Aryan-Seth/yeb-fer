  ...
  return (
    ...
    <div>
      {isDownloadingModel && <div style={{ textAlign: "center", marginTop: "30vh" }}>
        <img src={loading} />
        <h2 style={{ color: "#ffff00" }}>Downloading Model</h2>
      ...
      {!isDownloadingModel && <div>
        ...
        <div className="titleDiv">
          ...
          <div style={{ marginLeft: "10px", marginTop: "1vh" }}>
            <h2 style={{ fontSize: "4vh" }}>Emotion Detector</h2>



            <a className="nostyle">Deep Learning Model</a>
            <p className="nostyle">&nbsp;Birla Institute of Technology and Science, Pilani&nbsp;</p>
            <br />
